...
SPECIFIC_TEMPLATES=("config/binarystore-config-map.yaml" "artifactory-data-pvc.yaml" "artifactory-backup-pvc.yaml" "artifactory-primary-deployment.yaml" "artifactory-secondary-deployment.yaml")
